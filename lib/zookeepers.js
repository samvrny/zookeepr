...
function filterByQuery(query, zookeepers) {
    ...
    if(query.age) {
        filteredResults = filteredResults.filter(
            //Since our form data will be coming in as strings, and our JSON is storing age as a number, we must convert the query string to a number
...
module.exports = {
    ...
    findById,
    createNewZookeeper,
    validateZookeeper //MAY NEED TO add comma after this 
};